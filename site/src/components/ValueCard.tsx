...
export function ValueCard({ value }: { value: ServiceValue }) {
  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-[1.25rem] bg-orange/[0.06] p-7 ring-1 ring-navy/10 transition duration-300 ease-[var(--ease-out-expo)] hover:-translate-y-1 hover:bg-paper hover:shadow-[0_24px_50px_-28px_rgba(15,44,63,0.55)] hover:ring-navy/15 sm:p-8">
      <span
        aria-hidden="true"
