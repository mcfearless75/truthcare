...
12. **NEW 2026-08-13 — Google is still serving the OLD Wix page title.** A live Google search for "Truth Care Group Beaconsfield House" returns the homepage titled *"Truth Care Group | Brain Injury Residential Rehabilitation **Bristol**"* with a matching Bristol-led description — that is the pre-cutover Wix metadata, not this build's Weston-super-Mare title. Expected, since DNS only cut over on 13 August and Google has not recrawled. **Action: request re-indexing of the homepage in Search Console** (already on the original cutover checklist as step 8, apparently not done). Re-check in a few days; if it persists past a couple of weeks, investigate properly.
13. **NEW 2026-08-13 — `team.ts` nursing wording was changed, but the bios were not audited.** The page-level heading and lede now draw the personal-care-vs-nursing-care distinction correctly. The six individual bios below are the client's verbatim copy and were deliberately left untouched; they have **not** been read line-by-line against the no-nursing-care condition of registration. Worth doing next time the team page is open.
